            ...
            <form onSubmit={handleSubmit(onSubmit)} className='form container alert alert-dark position-relative'>
                ...
                <div className='mb-3'>
                    <div className='form-check'>
                        <input type="radio" className='form-check-input' id='authTypeUsuario' value='usuario' name='authType' />
                        <label htmlFor="authTypeUsuario" className='form-check-label'>Usuário</label>
                    </div>
                    <div className='form-check'>
                        <input type="radio" className='form-check-input' id='authTypeFuncionario' value='funcionario' name='authType' />
